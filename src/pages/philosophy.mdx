...
Under the Ground, at its core, consists of working code, best practices, design resources, human-centered guidelines, and vibrant community of best software
engineers and designers.

## Design Language
As the Wish Work team tried to deliver state-of-the-art products through complex systems, this design system emerged, helping develop a common language for designers, developers, and stakeholders. 
Establishing a design language allows everyone to speak the same design language without translating from one language to another.
...
### <p style={{color: colors.pink[3]}}>Simplicity</p> 
...
### <p style={{color: colors.pink[3]}}>Engineered </p>
...
### <p style={{color: colors.pink[3]}}>Integrity without Similarity</p>
...
### <p style={{color: colors.pink[3]}}>Inspired</p>
